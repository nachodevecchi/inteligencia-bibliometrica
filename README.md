...
El repositorio contiene tres módulos. El primero es un **prerequisito** para los módulos 1 y 2. El módulo 2 puede usarse de forma independiente, sin necesidad del Módulo 0.
